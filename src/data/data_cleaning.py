...
class CleanData:
    def __init__(self, data_dir, train_dir, valid_dir, test_dir, external_dir) -> None:
    ...
    def split_df_to_train_and_test(
        self, df_: pd.DataFrame, test_valid_size, test_valid_split
    ):
